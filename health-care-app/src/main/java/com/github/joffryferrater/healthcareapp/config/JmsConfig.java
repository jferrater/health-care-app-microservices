package com.github.joffryferrater.healthcareapp.config;
...
public class JmsConfig {
    ...
    public CachingConnectionFactory connectionFactory() {
        ...
        factory.setClientId("health-care-app");
    ...
    public DefaultJmsListenerContainerFactory jmsListenerContainerFactory() {
        ...
        factory.setErrorHandler(t -> LOGGER.error("An error occurred while listenining to the message, error: {}", t.getMessage()));
        return factory;
    }
